...
#pragma warning(disable:4996) // for function unsafe

#pragma warning(disable:4267) // for conversion data_type , possible loss of data

#pragma warning(disable:4312) // for conversion data_type of greater size

#pragma warning(disable:4311) // for warnging pointer truncation 

#pragma warning(disable:4800) // for warnging forcing value to bool 
