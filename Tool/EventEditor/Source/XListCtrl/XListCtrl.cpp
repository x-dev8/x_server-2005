...
int CXListCtrl::InsertItem(const LVITEM* pItem)
{
	...
	pXLCD[0].dwItemData   = static_cast<DWORD>(pItem->lParam);	//+++
...
/////////////////////////////////////////////////////////////////////////////
// SetEdit
BOOL CXListCtrl::Resume(int nItem, int nSubItem)
{
	ASSERT(nItem >= 0);
	ASSERT(nItem < GetItemCount());
	if ((nItem < 0) || nItem >= GetItemCount())
	...
	pXLCD[nSubItem].bCombo = FALSE;
	pXLCD[nSubItem].nCheckedState = -1;
	pXLCD[nSubItem].bEdit = FALSE;
