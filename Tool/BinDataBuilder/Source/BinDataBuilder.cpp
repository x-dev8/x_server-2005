...
// 唯一的一个 CItemFactoryApp 对象

CBinDataBuilderApp theApp;

// CBinDataBuilderApp 初始化
...
void CBinDataBuilderApp::ShowVersionInformation()
{
    ...
    strVersion.Format("打包工具 %s", ApplicationConfig::Instance().GetFullVersion());
