...
protected:
    ...
    HRESULT Render3DEnvironment(float totalTime, float deltaTime);
...
protected:
    ...
    HWND              m_hMainWnd;              // The main app window
    ...
    virtual HRESULT RestoreDeviceObjects(bool bInitEngineInstance=true)  { return S_OK; }
    virtual HRESULT FrameMove()                                { return S_OK; }
    virtual HRESULT Render(float totalTime, float deltaTime )  { return S_OK; }
...
public:
	...
	void GetBackbufferWidthHeight(UINT& width, UINT& height){width = m_d3dsdBackBuffer.Width; height = m_d3dsdBackBuffer.Height;};
};
