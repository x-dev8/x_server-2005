...
{
    return  CWnd::Create(m_strMyClass, _T("RollupCtrl"), dwStyle, rect, pParentWnd, nID);
}
...
void CRollupCtrl::OnContextMenu(CWnd* pWnd, CPoint point) 
{
    ...
    {
        menu.AppendMenu(MF_STRING,      RC_IDM_EXPANDALL,   _T("Expand all")    );
        menu.AppendMenu(MF_STRING,      RC_IDM_COLLAPSEALL, _T("Collapse all")  );
