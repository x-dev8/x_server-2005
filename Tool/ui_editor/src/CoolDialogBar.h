...
// Operations
public:
	void	Show( CFrameWnd* pFmWnd, CDialog* pDlg, UINT nDlgId, char* pTileName, DWORD dwStyle = CBRS_LEFT );//------- œ‘ æ    (By WitSun at 2004-5-12)
...
public:
    ...
    public:
    virtual BOOL Create(CWnd* pParentWnd, CDialog *pDialog, char* szTitle, UINT nID, DWORD dwStyle = CBRS_LEFT);
