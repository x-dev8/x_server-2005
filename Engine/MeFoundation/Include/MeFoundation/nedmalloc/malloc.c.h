...
DEBUG                    default: NOT defined
  ...
  this code or diagnose problems when porting to MeNew platforms.
...
/*
  create_mspace creates and returns a MeNew independent space with the
...
/*
  ...
  of a MeNew mspace. Part (less than 128*sizeof(size_t) bytes) of this
...
/*
  ...
  used for chunks to reduce fragmentation -- MeNew adjacent memory is
...
/* Initialize bins for a MeNew mstate that is otherwise zeroed out */
...
/* Add a segment to hold a MeNew noncontiguous region */
...
static void* sys_alloc(mstate m, size_t nb) {
  ...
  /*
    ...
    2. A call to MMAP MeNew space (disabled if not HAVE_MMAP).
  ...
  */
  ...
  if (tbase != CMFAIL) {
    ...
    if (nb < m->topsize) { /* Allocate from MeNew or extended top space */
...
History:
    ...
    V2.7.0 Sun Mar 11 14:14:06 2001  Doug Lea  (dl at gee)
      ...
      * MeNew WIN32 sbrk, mmap, munmap, lock code from <Walter@GeNeSys-e.de>.
