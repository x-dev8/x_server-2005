...
public:
    ...
    const Vector& getPoint(unsigned short index) const;
    ...
    */
    void updatePoint(unsigned short index, const Vector& value);
    ...
    */
    ...
    @param t Parametric value
    */
    Vector interpolate(int fromIndex, float t) const;
