...
struct SMtlAnimKeyframe : public MeCommonAllocObj<SMtlAnimKeyframe>
{
	DWORD	dwTime;
...
struct SMtlAnimTrack : public MeCommonAllocObj<SMtlAnimTrack>
{
	DWORD	dwLength;
...
struct SMtlAnimTexture : public MeCommonAllocObj<SMtlAnimTexture>
{
	SMtlAnimTexture();
	~SMtlAnimTexture();
	void	Destroy();
...
class MtlAnim : public MeCommonAllocObj<MtlAnim>
{
public:
	enum
	{
