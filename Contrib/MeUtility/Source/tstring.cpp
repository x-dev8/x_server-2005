...
std::vector<std::string> _tstring::tokenize(const std::string& src, std::string tok, bool trim, std::string null_subst)
{
...
std::vector<std::string> _tstring::split(const std::string& src, std::string delimit, std::string null_subst)
{
	std::vector<std::string> v;
