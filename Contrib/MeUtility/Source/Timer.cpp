...
void MeTimer::reset()
{
	...
	DWORD oldMask = (DWORD)SetThreadAffinityMask(thread, (DWORD_PTR)mTimerMask);
...
//-------------------------------------------------------------------------
unsigned long MeTimer::getMilliseconds()
{
...
//-------------------------------------------------------------------------
unsigned long MeTimer::getMicroseconds()
{
    LARGE_INTEGER curTime;
...
//-------------------------------------------------------------------------
unsigned long MeTimer::getMillisecondsCPU()
{
...
//-------------------------------------------------------------------------
unsigned long MeTimer::getMicrosecondsCPU()
{
	clock_t newClock = clock();
