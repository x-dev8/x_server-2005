...
enum EResult
{
	...
	ER_EnterWorldWhithOffineStall,     //lyh++ 进入游戏失败，在离线摆摊，从新登陆
    ...
    ER_TargetCountryCountError,           // 目标国家人数出错
    ER_OtherCountryCountError ,           // 其他国家人数出错
    ER_CoutryMaxCountLimit1   ,           // 国家人数被限制中
    ER_CoutryMaxCountLimit2   ,           // 国家人数被限制中
    ER_QuestFail,                         // 任务失败
    ...
    ER_CountryMountStorage,             // 国家特殊坐骑无法放入仓库

    ER_SysDoubleExpTimeLimit,           // 系统双倍经验时间达到上限
    ER_ItemDoubleExpTimeLimit,          // 系统双倍经验时间达到上限
    ER_VigorNotEnoughBeginOfflineFight, // 精力不够挂机战斗
    ER_VigorNotEnoughOnOfflineFight ,   // 精力被挂机中战斗消耗完

    ER_CharAssignPotential,             // 人物潜力点分配出错
    ER_NameNotExist,					// 不存在这个名字的玩家

    ER_ProfessionToLearnXinFa,          // 职业不对无法学习心法
    ER_NoLevelToLearnXinFa,             // 等级不足无法学习心法
    ER_NoMoneyToLearnXinFa,             // 金钱不足无法学习心法
    ER_NoExpToLearnXinFa,               // 经验不足无法学习心法
    ER_NoPrevXinFa,                     // 不能越阶学习心法
    ER_LearnXinFa,                      // 您不能学习这本心法书

    ER_NoRideMultiMount ,               // 对方没有多人载具
    ER_HasRideMultiMount,               // 你已经坐在多人载具
    ER_NoTeamMultiMount,                // 不是组队队员无法请求上载具
    ER_MultiMountIsFull,                // 对方载具人数已满
    ER_GotOffMultiMount,                // 请求下载具出错
    ER_TargetNotInRange,                // 对方不在视野范围内

    ER_NoFoundQuestItem,                // 没有找到任务物品
    ER_QuestItemCommit,                 // 提交任务物品不足

    ER_NotFoundPet,                     // 没有找到宠物数据
    ER_PetPotential,                    // 宠物潜力点分配错误
    ER_PetNumIsFull,                    // 携带宠物已满
    ER_PetTakeLevel,                    // 携带等级不足
    ER_InFightNotActivePet,             // 战斗状态宠物无法出战
    ER_InDeadNotActivePet,              // 死亡状态宠物无法出战
    ER_LifeNotActivePet ,               // 寿命不足宠物无法出战
    ER_LoyaltyNotActivePet ,            // 快乐度不足宠物无法出战 
    ER_PetRegenerateTime,               // 重生时间还未到
	ER_MapNotActivePet,					// 当前地图不能出战

    ER_PetHasBreed,                     // 繁殖过的宠物无法还童
    ER_PetIsAberrance,                  // 变异宠物无法还童

    ER_PetLearnSkill,                   // 宠物技能学习失败
    ER_PetLevelSkill,                   // 宠物等级不足学习失败
    ER_PetSkillMoney,                   // 金钱不足无法学习

    ER_PetSavvyUpMoney,                 // 金钱不足无法提升悟性
    ER_PetSavvyBone,                    // 根骨不足无法提升悟性
    ER_PetSavvyUp,                      // 宠物提升悟性失败
    ER_IsActivePet,                     // 出战宠物无法进行操作
    ER_ItemSavvy,                       // 道具无法提升选中的宠物悟性

    ER_CatchSkillLevel,                 // 宠物捕捉技能等级不足
    ER_PetIdentify,                     // 没有宠物图鉴无法捕捉
    ER_PetCatchFail,                    // 捕捉宠物失败

    ER_HasPetSkill,                     // 宠物已经学习了该技能
    ER_PetSkillGroupLevel,              // 宠物已经学习高级技能

    ER_PetSavvyReduce,                  // 使用宠物提升悟性失败!悟性不小心降到了

    ER_MountMaxRangeTimer,              // 超出最大活动范围,%d秒后离开载具
    ER_MountBackMaxRange,               // 您回到了活动范围内

	ER_ChangePKModeAttact,				// 在特殊PK模式下不可以手动切换其他PK模式
};
