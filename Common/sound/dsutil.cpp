                                               ...
                                               DWORD dwPrimaryBitRate )
{
	...
	//pDSBPrimary->GetFormat( &wfx,sizeof( wfx ),NULL );
                               ...
                               DWORD dwNumBuffers )
{
	...
	if( pWaveFile->m_pwfx->nChannels > 1 )
	{
		pWaveFile->m_pwfx->nChannels = 1;
		pWaveFile->m_pwfx->nBlockAlign = pWaveFile->m_pwfx->wBitsPerSample / 8;
		pWaveFile->m_pwfx->nAvgBytesPerSec = pWaveFile->m_pwfx->nSamplesPerSec * 
			pWaveFile->m_pwfx->nBlockAlign;
	}
