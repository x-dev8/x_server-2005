...
public:
	enum
	{
		...
		enum_in_list_state_nor_normal,	//此Center处于正常连接的链表中
		enum_in_list_state_waite_close,	//此Center处于等待关闭的链表中
	};
public:
	CServerSession(void);
	~CServerSession(void);
...
private:
	...
	short			 m_in_list_state;			//此client在哪里？
