...
class CenterTimeHandleManager  : public ISingletion<CenterTimeHandleManager>//应该Center和GameServer 各一个 之间不进行相互通讯 各自有各自的Update 和时间
{
public:
	CenterTimeHandleManager();
	~CenterTimeHandleManager(){}
...
#define theCenterTimeHandleManager CenterTimeHandleManager::Instance()