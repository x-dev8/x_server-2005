...
//    { 
//        LOG_MESSAGE( BILLINGOBJECT, LOG_PRIORITY_INFO, "处理充值反馈失败 typeId[%d] guid[%u]", pMessage->typeId, pMessage->guid );
//        return; 
//    }
//
//    LOG_MESSAGE( BILLINGOBJECT, LOG_PRIORITY_INFO, "处理充值反馈成功 typeId[%d] guid[%u]", pMessage->typeId, pMessage->guid );
//}
//
