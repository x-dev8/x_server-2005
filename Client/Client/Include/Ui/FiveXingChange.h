/********************************************************************
	...
	FileName: C:\Documents and Settings\liuchuanpeng\桌面\4xing\FiveXingChange.h
*********************************************************************/
#pragma once
#include "MeUi/MeUi.h"
#include "FiveXingBase.h"

#ifndef ID_FRAME_FiveXingChange
#define ID_FRAME_FiveXingChange		"ID_FRAME_FiveXingChange"
#endif  ID_FRAME_FiveXingChange
...
#include "UiBase.h"
class CUI_ID_FRAME_FiveXingChange : public CFiveXingBase ,public CUIBase
{
	// Member
public:	
	 CUI_ID_FRAME_FiveXingChange();
private:
	 ControlFrame*	m_pID_FRAME_FiveXingChange;
...
public:
	...
	ControlFrame* GetFrame() {return m_pID_FRAME_FiveXingChange;}
...
extern CUI_ID_FRAME_FiveXingChange s_CUI_ID_FRAME_FiveXingChange;
