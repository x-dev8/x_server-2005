/********************************************************************
	...
	FileName: E:\work\YiQiDangQian\Program\trunk\Bin\Client\Data\Ui\Repurple.h
*********************************************************************/
#pragma once
#include "MeUi/MeUi.h"

#ifndef ID_FRAME_Repurple
#define ID_FRAME_Repurple		"ID_FRAME_Repurple"
#endif  ID_FRAME_Repurple
...
class CUI_ID_FRAME_Repurple : public EquipEvolveUI
{
	// Member
public:	
	 CUI_ID_FRAME_Repurple();
...
protected:
	...
	bool _UnLoadUI();			// 卸载UI
protected:
	virtual int			GetEvolveType(){return MsgEquipEvolve::ET_ReOpenLight;}
	virtual int			GetEvolveMaterialType() {return  ItemDefine::ematerial_reopenlight;}
...
extern CUI_ID_FRAME_Repurple s_CUI_ID_FRAME_Repurple;
