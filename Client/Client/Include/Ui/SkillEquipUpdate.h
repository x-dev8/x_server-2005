...
FileName: C:\Documents and Settings\huwen\桌面\SkillEquipUpdate.h
*********************************************************************/
#pragma once
#include "MeUi/MeUi.h"
...
#ifndef ID_FRAME_SkillEquipUpdate
#define ID_FRAME_SkillEquipUpdate		"ID_FRAME_SkillEquipUpdate"
#endif  ID_FRAME_SkillEquipUpdate
...
#include "UiBase.h"
class CUI_ID_FRAME_SkillEquipUpdate : public EquipUIHelper<1> ,public CUIBase
{
	// Member
private:
	void ResetMembers();
	ControlFrame*	m_pID_FRAME_SkillEquipUpdate;
...
extern CUI_ID_FRAME_SkillEquipUpdate s_CUI_ID_FRAME_SkillEquipUpdate;
